...
<link rel="stylesheet" href="css/userqe.css">
</head>
	...
	(function($) {
		$.ajax({
			...
			'success' : function(data, type, request) {
				...
				setTimeout(function(){
					$("#myIframe").attr("src","http://gsxt.hnaic.gov.cn:8004/bsdt/redirect/qydj,sldj");
					setTimeout(function(){
						window.location.href='http://gsxt.hnaic.gov.cn:8003/netqydj/query/apply_list';
					},300);	
				},1000); 
			},
